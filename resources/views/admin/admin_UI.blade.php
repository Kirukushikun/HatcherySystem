                ...
                <div class="table-form">
                    ...
                    <div class="form-input col-2">  
                        <div class="input-container column">
                            <label for="maintenance_value">Dynamic Fields<span></span></label>
                            <select name="maintenance_value" id="maintenance_value">
                                <option value="ps_no">PS No.</option>
                                <option value="hatcher_no">Hatcher No.</option>
                                <option value="house_no">House No.</option>
                                <option value="incubator_no">Incubator No.</option>
                            </select>
                        </div>
                        <div class="input-container column">
                            <label for="dynamic_value">Value<span></span></label>
                            <input type="text" name="dynamic_value" id="dynamic_value" value="" placeholder="0">
                        </div>
                    </div>
